      ...
      <div class="px-6 py-4">
        ...
        <ValidationProvider name="競技カテゴリー" rules="required" v-slot="v">
          <label
            for="area1"
            class="block text-sm font-medium mt-2 text-gray-700"
            >競技カテゴリー <span class="text-red-400">※必須</span></label
          >
          <select
        ...
        <ValidationProvider name="モチベーション" rules="required" v-slot="v">
          <label
            for="area1"
            class="block text-sm font-medium mt-2 text-gray-700"
            >モチベーション <span class="text-red-400">※必須</span></label
          >
          <select
          ...
          >
            ...
            <option
              >エンジョイでは物足りない。ハードすぎずしっかりめにやりたい</option
            >
        ...
        >
          <div>
            <label
              for="area1"
              class="block text-sm font-medium mt-2 text-gray-700"
              >市区町村① <span class="text-red-400">※必須</span></label
            >
            <input
              type="text"
          ...
          <div>
            <div class="mt-1">
              <label
                for="area1"
                class="block text-sm font-medium mt-2 text-gray-700"
                >自己紹介 <span class="text-red-400">※必須</span></label
              >
              <textarea
                id="selfIntroduction"
